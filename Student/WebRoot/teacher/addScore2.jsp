  ...
  <body>
    <div id="main" >
		...
		<div  id="right">
  		...
  		<div id="scoreinfo">
  			<form action="teacher/addScoreAction.jsp" method="post">
			   ...
			   <jsp:useBean id="sco" class="vo.Score"></jsp:useBean>		<%--产生成绩对象sco --%>			  
				...
				for(int i=0;i<al.size();i++){
				     ...
				     if(score!=null&&score!=0){%>
			    		...
			    		alert("成绩已录入！");
			    		window.location.href="addScore.jsp";
						</script>
					  <%} %> 
					    <tr>
					    <td><%=stuno %><input type="hidden" name="stuno" value="<%=stuno %>"></td>
					    <td><%=stuname %></td>
					    <td><input type="text" name="score" ></td>					   
					    </tr>					  
			    <% }scodao.closeConnection();%>  
  				<tr>
  					<td colspan="3"><input type="hidden" name="courseno" value="<%=courseno %>"><input type="submit" value="录入"/><input type="submit" value="取消"/></td>
  				</tr>
  				</table>
  				</form>
  		</div>
